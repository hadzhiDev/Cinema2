...
urlpatterns = [
    ...
    path('directors/', views.list_of_directors, name='workspace_directors'),
    path('directors/create/', views.create_director, name='workspace_create_director'),
    path('directors/<int:id>/update/', views.update_director, name='workspace_update_director'),
    path('directors/<int:id>/delete/', views.delete_director, name='workspace_delete_director'),
